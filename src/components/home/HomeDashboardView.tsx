...
export const HomeDashboardView: React.FC<HomeDashboardViewProps> = ({
  ...
  const allMenus = [
    ...
    { no: 4, nama: 'Laporan Pembelian Barang', judul: 'Rekapitulasi Pembelian Multi-Parameter, Potongan Kuli & Tikar (PRD Bab 8)', modId: 'modul-6-laporan-pembelian' },
    ...
    { no: 8, nama: 'Master Petani', judul: 'Data Petani Tembakau & Kartu Scan Setoran (PRD 4.1)', modId: 'modul-1-petani' },
    ...
    { no: 17, nama: 'Manajemen Pengguna (RBAC)', judul: 'Otorisasi Staf & Hak Akses 5 Role Kerja (PRD Bab 3)', modId: 'modul-users' },
  ];
